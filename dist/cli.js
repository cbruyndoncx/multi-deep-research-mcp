...
import { createRequestSchema, statusSchema, listModelsSchema, handleCreateTool, handleStatusTool, handleResultsTool, reasoningModelsHandler, reasoningProvidersHandler, } from "./handlers.js";
...
async function readFileIfProvided(filePath) {
    if (!filePath) {
        return undefined;
    }
    return fs.readFile(filePath, "utf8");
}
async function readParametersFile(filePath) {
    if (!filePath) {
        return undefined;
    }
