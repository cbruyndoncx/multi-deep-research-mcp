...
export async function handleCreateTool(inputs: CreateInputs) {
  try {
...
export async function handleStatusTool(inputs: StatusInputs) {
  try {
...
export async function handleResultsTool(inputs: StatusInputs) {
  try {
...
export async function reasoningModelsHandler(inputs: z.infer<typeof listModelsSchema>) {
